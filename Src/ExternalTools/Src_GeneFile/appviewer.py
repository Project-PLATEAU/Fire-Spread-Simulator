...
parser.add_argument('-simcolor','--simcolor',action='store_true',help='paint by simfire result',default=False)
...
parser.add_argument('-lod1','--lod1',action='store_true', help='use LOD1 in bldg.')
