...
namespace SimulationSourceFileCreator.Controller
{
    ...
    internal class ConfigFileManager
    {
        ...
        /// 設定キー：入力フォルダパス
        /// </summary>
        internal static string KeyInputFolderPath => "InputFolderPath";

        /// <summary>
        /// 設定キー：入力ファイルパス
        /// </summary>
        internal static string KeyInputFilePath => "InputFilePath";

        /// <summary>
        /// 設定キー：出力フォルダパス
        /// </summary>
        internal static string KeyOutputFolderPath => "OutputFolderPath";
