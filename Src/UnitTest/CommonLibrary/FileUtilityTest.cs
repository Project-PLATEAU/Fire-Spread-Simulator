...
public class FileUtilityTest
{
    ...
    public void TestMethod_Success()
    {
        ...
        CheckContent(expectedFilePath, destFilePath);
    ...
    public void TestMethod_Exception(string sourceFilePath, string destFilePath, bool rewriteActionIsNull, bool encodingIsNull, string expectedExceptionItem)
    {
    ...
    public void TestMethod_Failure(string sourceFileName, string destFileName)
    {
    ...
    private static void CheckContent(string expectedFilePath, string actualFilePath)
    {
