...
namespace SimulationSupportTool
{
    ...
    public partial class App : Application
    {
        ...
        /// ミューテックス
        /// </summary>
        private readonly Mutex mutex = new Mutex(false, "SimulationSupportTool_Mutex");
        ...
        public App()
        {
            AppDomain.CurrentDomain.UnhandledException += (sender, args) =>
            {
                ...
                MessageBoxUtility.ShowError("エラーが発生しました。アプリケーションを終了します。", "条件設定支援ツール");
                Current.Shutdown();
            };
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            try
            {
                ...
                if (!this.isStartUp)
                {
                    ...
                    MessageBoxUtility.ShowWarning("アプリケーションは既に起動しています。", "条件設定支援ツール");
                    Current.Shutdown();
                    return;
                }
            }
