...
- 本システムのファイル作成ツール内の防火属性付加機能の開発にあたっては国総研市街地延焼シミュレーションプログラムの「防火属性付加ツール」を参考にして開発しています。
- ファイル作成ツール内の防火属性付加機能の著作権は国土交通省と国土技術政策総合研究所に帰属します。
- 本システムのファイル作成ツールの開発にあたっては国総研市街地延焼シミュレーションプログラムの「シミュレーション用データ変換ツール」に、以下の改変を加え、実行形式ファイル化して使用しています。
  ...
  - ファイル作成ツール内のシミュレーション用データ変換機能の著作権は、改変した部分は国土交通省、それ以外の部分は国土技術政策総合研究所に帰属します。
