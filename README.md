...
- エンジンの詳細は、「[「高度な画像処理による減災を目指した国土の監視技術の開発　総合報告書(平成２２年１2月　国土交通省)」](https://www.gsi.go.jp/common/000226161.pdf)」で確認いただけます。
...
<font color="red">※要確認：国総研より提供いただいた「防火属性付加ツール」及び「シミュレーション用データ変換ツール」をファイル作成ツールに組み込んでおり、OSS化にも同意いただいているが、著作権は国総研にあるのではないか？その場合、本記載を変更する必要がある。<br>
各種ライブラリについても、同様かと思いますが、各種ライブラリのソースコードは本GitHubには含めない（リリースページには含める）ので、上記記載で問題ないという認識でよいか？※本システムに使用しているライブラリがソースコードと不可分となっていないか念のため確認</font>
...
- 国土交通省総合技術開発プロジェクト 「高度な画像処理による減災を目指した国土の監視技術の開発　総合報告書(平成２２年１2月　国土交通省)」: https://www.gsi.go.jp/common/000226161.pdf
